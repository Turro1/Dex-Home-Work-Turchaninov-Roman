...
namespace Home_work__9._1__Reflection_
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            FiguereProperties_1(figure);

            FigureProperties_2("Home_work__9._1__Reflection_.Figure");
            MethodFromProjectTwo(figure);
        }

        static void FiguereProperties_1(object obj)
        {
        ...
        static void FigureProperties_2(string typeName)
        {
